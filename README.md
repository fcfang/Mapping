...
Another alternative for a Mapping App on your phone is obviously, the origin of the coordinates themselves. I started this project mapping the jpg in Google Earth. You can import the KML into Google Earth on your phone/tablet while you're out and about and find your grid squares that way too. The downside of Google Earth is that it relies on an active data connection which may make it less desirable in ARES situations than GAIA GPS which allows you to download offline maps. I've read that you can import APRS data into Google Earth from aprs.fi also but I'm unable to see any data points after importing their KML into Google Earth. I'll keep working on that as it might be nice for Net Control to have during an active event. While I have not been able to get the tablet or phone versions of the APRS.kml working, I did get it working just fine in Google Earth Pro on my desktop Windows. The KMZ file from that is also included in the repo, so you're welcome to try that or simply go to aprs.fi, customize your plotting criteria and export your own KML file to import into Google Earth Pro. 
